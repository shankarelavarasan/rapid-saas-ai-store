  ...
  const installContent = `
        <div class="install-modal">
            <div class="install-header">
                <img src="${app.icon || 'assets/default-app-icon.svg'}" alt="${app.name}" class="install-icon">
  ...
  const detailsContent = `
        <div class="app-details">
            <div class="app-details-header">
                <img src="${app.icon || 'assets/default-app-icon.svg'}" alt="${app.name}" class="details-icon">
